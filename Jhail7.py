...
cl = LINE("EznbYDXIFZ4bxUiXoOzd.OVxSbSJzU1FPeOwV43z3tq.liUyX36+f9se0sDlWZOBvdfWb93rcACPGiaE9xSuqNg=")
cl.log("Auth Token : " + str(cl.authToken))

ki = LINE("EzszoV4HenCii9y6WYK7.e0eeO4v+zed/X6BzU33p1W.PvUwNbKyHPGmF12VK/otp/eDUTVntGqUpJz2Fc1RH1Q=")
ki.log("Auth Token : " + str(ki.authToken))

kk = LINE("EzEX7GWCebIKvJt925o3.TLXNogrRFptK2nNaSi0XaW.sMgNwQNv4PDcoAjDyXuJYlr+LYhHCBFe06QfEshXv/A=")
kk.log("Auth Token : " + str(kk.authToken))

kc = LINE("EzzPsdV6vqGfgSi9Mwjb.QqGAYjAKLvR5VWikgL5ooW.7cKrcBNem0NE+EvcdNMI01OR+TssE1iU+YttgV+DBFM=")
kc.log("Auth Token : " + str(kc.authToken))

km = LINE("EzBIMPX8bw0H1hhfKVB3.A3M293vsj72GliSGNxsOWW.Y7QgJKyHCdsSGIIJqG7do9R28FA5t/kgzBT7jCfOSo4=")
km.log("Auth Token : " + str(km.authToken))

kb = LINE("Ez7xrPsXJlrBvnTSF1Jc.gNJz/nVBt/ydklYHQn7Npa.MGEDUxRtXiK1YMei9wwZcoQpZLHNL8bsF+Kxn+0odYI=")
kb.log("Auth Token : " + str(kb.authToken))

sw = LINE("EzPOrBMPk5dU2wfG7c74.AU737SO6W+NBa/k31Nbfja.khwJ3NYQL47aY0j2fTr+9e8JJ00SZEb9fRAiA4IhZmQ=")
sw.log("Auth Token : " + str(sw.authToken))

oepoll = OEPoll(cl)
call = cl
creator = ["ua2f5ec06c8d9bb57e91285afe376774d"]
owner = ["ua2f5ec06c8d9bb57e91285afe376774d"]
admin = ["ua2f5ec06c8d9bb57e91285afe376774d"]
staff = ["ua2f5ec06c8d9bb57e91285afe376774d"]
...
def help():
    ...
    helpMessage += "╚══════════════"
    helpMessage += " Creator: https://line.me/ti/p/~team_scorpion \n"
    return helpMessage
...
def helpbot():
    ...
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Anti baper on/off\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + ".Bye/Bye[1/4]\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Leave「Namagrup」\n"
    num = (num+1)    
    helpMessage2 += "║☯➸ %i. " % num + key + "Black「in」\n"
    num = (num+1)  
    helpMessage2 += "║☯➸ %i. " % num + key + "Black「out」\n"
    num = (num+1)    
    ...
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Geboy [kickall]\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Tamat [kickall]\n"
    num = (num+1)
    helpMessage2 += "║☯➸ %i. " % num + key + "Black \n"
    num = (num+1)
    ...
    helpMessage2 += "║" + "─⍟ᴛᴇᴀᴍ ʙᴏᴛ ᴘʀᴏᴛᴇᴄᴛ⍟─\n"
    helpMessage2 += "╚══════════════"
    helpMessage2 += " My ID LINE : https://line.me/ti/p/~team_scorpion \n"
    return helpMessage2
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                               try:
                                   ...
                                   cl.sendMessage(msg.to,"Si mantan sudah aq  ceburin ke kali")
                                   ki.sendMessage(msg.to,"Mantan q sudah aq ceburin ke sungai")
                                   kk.sendMessage(msg.to,"Mantan q sudah aq ceburin ke empang")
                                   kc.sendMessage(msg.to,"Mantan q sudah aq ceburin ke laut")
                                   km.sendMessage(msg.to,"Bersih bos")
                                   kb.sendMessage(msg.to,"Kinclong Sudah")
                               except:
                                   pass
...
#===========BOT UPDATE============#
                        elif cmd == "mention" or text.lower() == 'woy':
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "✪BLACK ₭ιll₠₹ 1⋮➲Ready...➤")
                               kk.sendMessage(msg.to, "✪BLACK₭ιll₠₹ 2⋮➲Ready..,➤")
                               kc.sendMessage(msg.to, "✪BLACK ₭ιll₠₹ 3⋮➲Ready...➤")
                               km.sendMessage(msg.to, "✪BLACK ₭ιll₠₹ 4⋮➲Ready..,➤")
                               kb.sendMessage(msg.to, "✪BLACK ₭ιll₠₹ 5⋮➲Ready...➤")
...
#===========Protection============#
                        ...
                        elif 'Anti baper ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('Anti baper ','')
                              if spl == 'on':
                                  if msg.to in protect["antijs"]:
                                       msgs = "Anti Janda has been active"
                                  else:
                           ...
                           if msg._from in owner or msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Semua pelindung dari Janda  on \n\ndi group : " +str(ginfo.name)
                                  else:
                                      protectcancel.append(msg.to)
                                      ginfo = cl.getGroup(msg.to)
                                      msgs = "Succes\nIn group : " +str(ginfo.name)
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                             if msg.toType == 2:
                                 ...
                                 cl.sendMessage(msg.to,"「 Sorry r̸o̸o̸m̸ n̸y̸a̸ k̸a̸m̸i̸ s̸i̸t̸a̸ s̸e̸e̸ y̸o̸u̸ s̸l̸a̸m̸ d̸a̸r̸i̸ TΣΔM Pemburu Janda Genit」")
                                 targets = []
                                 for g in gs.members:
...
#===========COMMAND SET============#
                        ...
                        elif 'Setsider: ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('setsider: ','')
                              if spl in [""," ","\n",None]:
                        ...
                        elif text.lower() == "cekrespon":
                            if msg._from in admin:
                               cl.sendMessage(msg.to, "「Respon Msg」\nRespon Msg mu :\n\n「 " + str(wait["Respontag"]) + " 」")

                        elif text.lower() == "cekspam":
                            if msg._from in admin:
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               try:ki.inviteIntoGroup(to, ["ua2f5ec06c8d9bb57e91285afe376774d"]);has = "OK"
                               except:has = "NOT"
                               try:ki.kickoutFromGroup(to, ["ua2f5ec06c8d9bb57e91285afe376774d"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kc.inviteIntoGroup(to, ["u134104a3857f6440fec7a6d9bb7dcfd7"]);has = "OK"
                               except:has = "NOT"
                               try:kc.kickoutFromGroup(to, ["ub65c6738646b7cf4e4d8d9c0b08d3103"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kc.inviteIntoGroup(to, ["ua9081ac896a4955af9bf020a1a5e4e3b"]);has = "OK"
                               except:has = "NOT"
                               try:km.kickoutFromGroup(to, ["u6b79b6f7755227bda02c8b209d74a8c3"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kb.inviteIntoGroup(to, ["u1a78d9f8dbdb4fe60328bca1a8dee73c"]);has = "OK"
                               except:has = "NOT"
                               try:kb.kickoutFromGroup(to, ["u6aeef7eeca3ac3f9db03e2b7d6704524"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
